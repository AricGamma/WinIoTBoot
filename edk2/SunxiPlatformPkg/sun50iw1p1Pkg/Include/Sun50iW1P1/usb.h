...
#define  USBC_Readb(reg)                      MmioRead8(reg)
#define  USBC_Readw(reg)                      MmioRead16(reg)
#define  USBC_Readl(reg)                      MmioRead32(reg)


#define  USBC_Writeb(value, reg)                MmioWrite8( (reg),(value))
#define  USBC_Writew(value, reg)          MmioWrite16( (reg),(value))
#define  USBC_Writel(value, reg)          MmioWrite32( (reg),(value))
...
#define  USBC1_BASE                 0x01c1A000
#define  USBC2_BASE                 0x01c1B000
