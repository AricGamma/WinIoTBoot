...
************************************************************************************************************
*/
int SunxiClockGetC0CorePll(void)
{
...
void enable_pll_lock_bit(unsigned int lock_bit)
{
  unsigned int reg_val;
  reg_val = readl(CCMU_PLL_LOCK_CTRL_REG);
  reg_val |= lock_bit;
...
void disable_pll_lock_bit(unsigned int lock_bit)
{
  unsigned int reg_val;
  reg_val = readl(CCMU_PLL_LOCK_CTRL_REG);
  reg_val &= (~lock_bit);
...
************************************************************************************************************
*/
int SunxiClockSetC0CorePll(int frequency)
{
  unsigned int reg_val;
