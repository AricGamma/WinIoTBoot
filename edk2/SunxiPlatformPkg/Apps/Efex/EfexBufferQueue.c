...
UINTN EFEX_BUFFER_QUEUE_PAGE_SIZE   = (64*1024);
...
)
{
  ...
  EFEX_INFO("Logic Page Size = %d\n", This->FlashIo->LogicPageSize);
  EFEX_BUFFER_QUEUE_PAGE_SIZE = This->FlashIo->LogicPageSize;
  Status =InitBufferQueue(&EfexBufferQueue,EFEX_BUFFER_QUEUE_MAX_LENGHT,
  EFEX_BUFFER_QUEUE_PAGE_SIZE,sizeof(EFEX_BUFFER_QUEUE_ELEMENT));
