  ...
  )
{
  ...
  SUNXI_VARIABLE_HOB                      *SunxiVariableHob  = NULL;
  ...
  NvStorageVariableBase = SunxiVariableHob->SunxiVariableBase;
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_ERROR, "Can't Init the non-volatile variable write. stuff\n"));
  return ;
  }
