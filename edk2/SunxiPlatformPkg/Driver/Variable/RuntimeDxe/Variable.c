  ...
  )
{
  ...
  UINT32                                BackUpOffset;
  UINT32                                BackUpSize;
  EFI_PHYSICAL_ADDRESS                  FvbVariableStoreBase;

  ASSERT(mVariableModuleGlobal->FvbInstance != NULL);
  ...
  mVariableModuleGlobal->FvbInstance->GetPhysicalAddress(mVariableModuleGlobal->FvbInstance,&FvbVariableStoreBase);
  NvStorageData = (UINT8*)(UINTN)FvbVariableStoreBase;
  NvStorageBase = FvbVariableStoreBase;
#if 0  
  ...
  )
{
  ...
  ASSERT(mVariableModuleGlobal->FvbInstance != NULL);
  mVariableModuleGlobal->FvbInstance->GetPhysicalAddress(mVariableModuleGlobal->FvbInstance,&NvStorageBase);
 #if 0
  NvStorageBase = (EFI_PHYSICAL_ADDRESS) PcdGet64 (PcdFlashNvStorageVariableBase64);
  if (NvStorageBase == 0) {
    NvStorageBase = (EFI_PHYSICAL_ADDRESS) PcdGet32 (PcdFlashNvStorageVariableBase);
