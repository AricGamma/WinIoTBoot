...
#if 1
#define __inf(msg...)       do{if (bsp_disp_get_print_level()){printk(KERN_WARNING "[DISP] %a,line:%d:",__func__,__LINE__);printk(msg);}}while (0)
#define __msg(msg...)       do{if (bsp_disp_get_print_level()){printk(KERN_WARNING "[DISP] %a,line:%d:",__func__,__LINE__);printk(msg);}}while (0)
#define __wrn(msg...)       do{{printk(KERN_WARNING "[DISP] %a,line:%d:",__func__,__LINE__);printk(msg);}}while (0)
#define __here__            do{if (bsp_disp_get_print_level()==2){printk(KERN_WARNING "[DISP] %a,line:%d\n",__func__,__LINE__);}}while (0)
#define __debug(msg...)     do{if (bsp_disp_get_print_level()==2){printk(KERN_WARNING "[DISP] %a,line:%d:",__func__,__LINE__);printk(msg);}}while (0)
#else
...
#define __inf(msg...)
#define __msg(msg...)
#define __wrn(fmt,msg...) AsciiPrint(fmt,##msg)
#define __here
#define __debug
...
#else
#define DE_INF(fmt,msg...) 
#define DE_MSG(fmt,msg...) 
#define DE_WRN(fmt,msg...)  AsciiPrint(fmt,##msg)
#define DE_DBG(fmt,msg...) 
