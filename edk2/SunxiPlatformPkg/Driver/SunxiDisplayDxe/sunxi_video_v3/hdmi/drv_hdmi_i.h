...
#define __msg(msg...)       do{if (hdmi_print){printk(KERN_WARNING "[HDMI] file:%a,line:%d:",__FILE__,__LINE__);printk(msg);}}while (0)
#define __wrn(msg...)       do{printk(KERN_WARNING "[HDMI WRN] file:%a,line:%d:    ",__FILE__,__LINE__);printk(msg);}while (0)
#define __here__            do{if (hdmi_print){printk(KERN_WARNING "[HDMI] file:%a,line:%d\n",__FILE__,__LINE__);}}while (0)
#else
#endif
