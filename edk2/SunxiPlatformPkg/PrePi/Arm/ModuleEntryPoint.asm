...
#include <Chipset/ArmV7.h>
  ...
  IMPORT  CEntryPoint
  IMPORT  ArmPlatformInitializeSystemMemory
  IMPORT  ArmPlatformIsPrimaryCore
  IMPORT  ArmReadMpidr
  IMPORT  ArmPlatformPeiBootAction
  IMPORT  ArmPlatformStackSet
  
  IMPORT  _gPcd_FixedAtBuild_PcdSystemMemorySize
...
_ModuleEntryPoint
  ...
  blx	ArmPlatformInitializeSystemMemory
...
_SetupStackPosition
  ...
  LoadConstantToReg (_gPcd_FixedAtBuild_PcdSystemMemorySize, r2)
  ldr   r2, [r2]
